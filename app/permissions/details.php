...
<body id="page-top">
    <div id="wrapper">
        ...
        <h2 style="text-align:center">Permissions Details</h2>
        <div class="mt-3">
            <p><strong>Name:</strong> <?php echo $permissions['name']; ?></p> <br>
        </div> 
        <div style="text-align:center">
        <a href="index.php" class="btn btn-primary mt-3">Back to Permissions</a>
        </div>
    </div>
    </div>  
</body>
